...
class ProxyManager:
    ...
    def __init__(self, api_key: str = None, amount: int = 250, fail_count: int = 3, host='localhost', port=6379, db=0, password: str = None):
        """
                ...
                if 'results' in data:
                    ...
                    for result in results:
                        ...
                        if not self.redis.exists(key):
                            self.redis.hset(key, mapping={"success": 0, "failure": 0, "timestamp": 0})
